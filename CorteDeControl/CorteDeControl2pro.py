...
listaProductos = [
    # Almacenamiento
    {'codigo': '00017', 'descripcion': 'Disco Rígido WD Blue 1TB', 'categoria': 'Almacenamiento', 'subcategoria': 'Interna', 'precio': 90000.0, 'stock': 30},
    {'codigo': '00018', 'descripcion': 'SSD Kingston A400 480GB', 'categoria': 'Almacenamiento', 'subcategoria': 'Interna', 'precio': 85000.0, 'stock': 25},
    {'codigo': '00019', 'descripcion': 'Pendrive Sandisk 64GB', 'categoria': 'Almacenamiento', 'subcategoria': 'Externa', 'precio': 20000.0, 'stock': 60},
    {'codigo': '00020', 'descripcion': 'Tarjeta MicroSD Samsung 128GB', 'categoria': 'Almacenamiento', 'subcategoria': 'Externa', 'precio': 35000.0, 'stock': 40},
    ...
    # Celular
    {'codigo': '00002', 'descripcion': 'Motorola G10', 'categoria': 'Celular', 'subcategoria': 'Android', 'precio': 800000.0, 'stock': 20},
    {'codigo': '00001', 'descripcion': 'Samsung A22', 'categoria': 'Celular', 'subcategoria': 'Android', 'precio': 500000.0, 'stock': 30},
    {'codigo': '00004', 'descripcion': 'Xiaomi Redmi Note 11', 'categoria': 'Celular', 'subcategoria': 'Android', 'precio': 600000.0, 'stock': 25},
    {'codigo': '00003', 'descripcion': 'iPhone 13', 'categoria': 'Celular', 'subcategoria': 'iOS', 'precio': 1500000.0, 'stock': 15},
...
while i < cantidad:
    ...
    totalCat = 0 
    cantCat = 0
    print("Categoria", categoriaActual,":") 
    while i < cantidad and categoriaActual == listaProductos[i]["categoria"]:
        subcategActual = listaProductos[i]["subcategoria"]
        totalSubcat = 0
        cantSubcat = 0
        while i < cantidad and categoriaActual == listaProductos[i]["categoria"] and subcategActual == listaProductos[i]["subcategoria"]:
            totalSubcat = totalSubcat + listaProductos[i]["precio"]
            cantSubcat = cantSubcat + 1
            i += 1
        print("   Total Subcategoria", subcategActual,": Precio: ", totalSubcat, "Cant:", cantSubcat) 
        totalCat = totalCat + totalSubcat
        cantCat = cantCat + cantSubcat
        
    print("Total Categoria", categoriaActual,": Precio: ", totalCat, "Cant:", cantCat)   
